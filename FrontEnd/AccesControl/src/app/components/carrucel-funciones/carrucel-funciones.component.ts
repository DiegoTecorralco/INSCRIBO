...
@Component({
  selector: 'app-carrucel-funciones',
  standalone:true,
  imports: [],
  templateUrl: './carrucel-funciones.component.html',
  styleUrl: './carrucel-funciones.component.css'
})
export class CarrucelFuncionesComponent implements AfterViewInit, OnDestroy {
  ...
  slides = [
    ...
    {image:'assets/co.png', alt:'marcos', bgClass:'bg-gray-100'}
  ];
