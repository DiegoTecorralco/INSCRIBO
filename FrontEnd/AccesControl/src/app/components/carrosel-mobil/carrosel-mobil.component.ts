...
@Component({
  selector: 'app-carrosel-mobil',
  imports: [],
  templateUrl: './carrosel-mobil.component.html',
  styleUrl: './carrosel-mobil.component.css'
})
export class CarroselMobilComponent implements AfterViewInit, OnDestroy {
